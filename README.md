...
|-----------|---------|-------------|------------|
| **v7 (active)** | branch **`v7`** · [V7.md](V7.md) | **0.3.5** | [`v0.3.5`](https://github.com/Tjjordan3/personal-data-spine/releases/tag/v0.3.5) (installers) |
...
## v7 updates (app **0.3.5**, tag **v0.3.5**)
...
- **Latest:** [`DonePath_0.3.5_x64-setup.exe`](https://github.com/Tjjordan3/personal-data-spine/releases/latest) (tag `v0.3.5`)
- Older: `DonePath_0.2.0_x64-setup.exe` (`v0.2.0`)
- SmartScreen may warn on unsigned builds → **More info → Run anyway**

### macOS (Apple Silicon + Intel)

- **Latest:** `DonePath_0.3.5_universal.dmg` on [Releases](https://github.com/Tjjordan3/personal-data-spine/releases/latest) (tag `v0.3.5`)
...
| | |
|--|--|
| **App version** | `0.3.5` (`package.json`, `src-tauri/tauri.conf.json`, `src-tauri/Cargo.toml`) |
| **Active branch** | `v7` |
